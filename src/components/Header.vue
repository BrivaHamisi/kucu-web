<template>
    ...
    <div class="container mx-auto px-5">
      <header class="flex justify-between py-12 items-center">
        <div>
          <router-link to="/"><img src="/images/logo-bookmark.svg" alt="Site Logo"></router-link>
        </div>
        ...
        <nav class="flex justify-end flex-col md:flex-row">
          ...
          <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex flex-col space-y-7 md:space-y-0 md:flex-row">
            <li class="uppercase hover:text-theme-secondary transition duration-200">
              <router-link :to="{ name: 'home' }" active-class="text-theme-secondary">Home</router-link>
            </li>
            <li class="uppercase hover:text-theme-secondary transition duration-200">
              <router-link :to="{ name: 'about' }" active-class="text-theme-secondary">About</router-link>
            </li>
            <li class="uppercase hover:text-theme-secondary transition duration-200">
              <router-link :to="{ name: 'resources' }" active-class="text-theme-secondary">Resources</router-link>
            </li>
            <li class="uppercase hover:text-theme-secondary transition duration-200">
              <router-link :to="{ name: 'committees' }" active-class="text-theme-secondary">Committees</router-link>
            </li>
            <li class="uppercase hover:text-theme-secondary transition duration-200">
        ...
        <div class="absolute px-5 py-12 block z-30 top-0 left-0 w-full h-full bg-gradient-to-b from-theme-dark-blue via-theme-dark-blue-tp to-theme-dark-blue">
          ...
          <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
            <li class="hover:text-theme-secondary transition duration-200 py-4 border-t border-b border-theme-grayish-blue w-full text-center">
              <router-link @click="toggleMobileNav" :to="{ name: 'home' }">Home</router-link>
            </li>
            <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
              <router-link @click="toggleMobileNav" :to="{ name: 'about' }">About</router-link>
            </li>
            <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
              <router-link @click="toggleMobileNav" :to="{ name: 'resources' }">Resources</router-link>
            </li>
            <li class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
              <router-link @click="toggleMobileNav" :to="{ name: 'committees' }">Committees</router-link>
            </li>
            <li class="hover:bg-[#cd3700] transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
