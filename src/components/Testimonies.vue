    ...
    <section class="py-20 px-4 md:px-8">
      <div class="container mx-auto max-w-6xl">
        ...
        <div class="max-w-sm mb-16">
          <h2 class="text-2xl font-bold mb-4">What People Say About Us</h2>
          <p class="text-gray-600">Nullam et elementum odio sed dui. Aenean non, viverra libero tortor bibendum integer consequat.</p>
        </div>
  
        <!-- Testimonial Grid Layout -->
        <div class="relative">
          <!-- Decorative Shapes -->
          <div class="absolute -left-8 bottom-20 w-12 h-12 rounded-full bg-teal-200/50"></div>
          <div class="absolute right-1/4 top-40 w-8 h-8 rounded-full bg-yellow-200/50"></div>
          <div class="absolute -right-4 bottom-32 w-16 h-16 rounded-full bg-pink-200/50"></div>
          <div class="absolute left-1/3 top-0 w-10 h-10 rounded-full bg-purple-200/50"></div>
  
          <!-- Testimonials Grid -->
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- First Column -->
            <div class="space-y-8">
              <!-- Single Card Top Left -->
